...
import { useUnauthorizedDrawer } from '@/lib/providers/unauthorizedDrawerProvider';
import { UISvg } from '@/ui/UISvg';
import DrawerContent from './DrawerContent';

const UnauthorizedDrawer = () => {
	const { isWelcomeVisible } = useUnauthorizedDrawer();
	...
	return (
		<Drawer
			...
			screenOptions={({ navigation }) => ({
				...
				headerRight: () => (isWelcomeVisible ? <UISvg name="leumitBrandLogoBlue" className="h-[29px] w-[112px]" /> : null),
				headerLeft: () => (
